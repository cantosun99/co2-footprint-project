/**
 * Alpine-Komponente für Filter, Sortierung, Sprachwahl und sichere Eingaben
 */
function co2Table() {
    return {
        ...
        // Eingabereinigung für Filter
        sanitize(field) {
            const blacklist = /[<>\\{}();:"'`]/g;
            this[field] = this[field].replace(blacklist, '');
        },
        ...
        // Gefilterte und sortierte Datenzeilen
        get filteredRows() {
